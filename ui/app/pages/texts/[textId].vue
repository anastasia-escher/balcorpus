...
<template>
  <article class="mx-auto max-w-4xl px-6 pt-12 pb-24">
    <NuxtLink
      to="/texts"
      class="text-xs text-link transition-colors hover:text-link-hover">
      {{ t('text.backToList') }}
    </NuxtLink>
    ...
    <!-- Only one text of the corpus has been annotated so far; the rest carry
         metadata and nothing to read yet. -->
